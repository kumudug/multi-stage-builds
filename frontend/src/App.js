...
//process.env.NODE_ENV is set in react build process
const backendUrl = process.env.NODE_ENV === 'development' ? 'http://localhost' : 'http://fargate-test-522996165.us-west-2.elb.amazonaws.com'
